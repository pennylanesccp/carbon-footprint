...
RAW_DIR = os.path.join(REPO_ROOT, "data", "raw", "road_data")
PROCESSED_DIR = os.path.join(REPO_ROOT, "data", "processed", "road_data")
if not os.path.exists(PROCESSED_DIR):
    os.makedirs(PROCESSED_DIR, exist_ok=True)
    logging.info(f"Created data directory: {PROCESSED_DIR}")

# Path to the large downloaded Excel file
EXCEL_FILE_PATH = os.path.join(RAW_DIR, "semanal-estados-desde-2013.xlsx")
# Path for the clean, final CSV
OUTPUT_CSV_PATH = os.path.join(PROCESSED_DIR, "latest_diesel_prices.csv")
